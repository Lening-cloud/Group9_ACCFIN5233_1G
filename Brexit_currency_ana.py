...
plt.savefig("result_currency_{}/wordcloud_{}.png".format(year,year), format='png', dpi=500)
plt.show()
...
with open('result_currency_{}/Posi_{}.txt'.format(year,year), 'w+') as f:
...
with open('result_currency_{}/Nega_{}.txt'.format(year,year), 'w+') as f:
